...
using ASC.Web.Compliance.Classes;
using ASC.Web.Compliance.Masters.ClientScripts;
using ASC.Web.Compliance.Resources;
using ASC.Web.Studio.Utility;

namespace ASC.Web.Compliance.Configuration
{
    public class ProductEntryPoint : Product
    {
        ...
        {
            get { return ComplianceResource.ProductName; }
        }
        ...
        public override string Description
        {
            get
            {
                ...
                if (CoreContext.UserManager.IsUserInGroup(id, ASC.Core.Users.Constants.GroupAdmin.ID) || CoreContext.UserManager.IsUserInGroup(id, Id))
                    return ComplianceResource.ExtendedProductDescription;

                return ComplianceResource.ProductDescription;
            }
        }
            ...
            context = new ProductContext
                {
                    ...
                    AdminOpportunities = () => ComplianceResource.ProductAdminOpportunities.Split('|').ToList(),
                    UserOpportunities = () => ComplianceResource.ProductUserOpportunities.Split('|').ToList(),
                };

            SearchHandlerManager.Registry(new ComplianceSearchHandler());
