...
namespace ASC.Web.Compliance.Classes
{
    public static class ComplianceDao
    {
        private const string DbId = "core";
        private const string Table = "Compliance_table";
        ...
        private static void CreateTable()
        {
            using (var db = GetDb())
            {
                ...
                .AddColumn("Name", DbType.String, 255, true);
        ...
        public static ComplianceClass Create(string value,string Name)
        {
            var result = new ComplianceClass
                {
                    Value = value
                };
        ...
        public static ComplianceClass Read(int id)
        {
            using (var db = GetDb())
            {
                ...
                var result = db.ExecuteList(query).ConvertAll(x => new ComplianceClass
                    {
        ...
        public static List<ComplianceClass> Read()
        {
            using (var db = GetDb())
            {
                var query = new SqlQuery(Table)
                ...
                return db.ExecuteList(query).ConvertAll(x => new ComplianceClass
                {
                    Id = Convert.ToInt32(x[0]),
                    Value = Convert.ToString(x[1]),
                    Name = Convert.ToString(x[2]),
        ...
        public static void Update(int id, string value,string Name)
        {
            using (var db = GetDb())
            {
