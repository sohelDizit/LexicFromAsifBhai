...
$(document).ready(function() {
    setTimeout(function() {
        ...
        Morris.Bar({
            ...
            barColors: ["0-#e11b22-#f01018", "0-#7B1B67-#A389D4", "#7b1b67"]
        });
        ...
        Morris.Area({
            ...
            lineColors: ['#A389D4', '#e11b22', '#7b1b67'],
            xkey: 'period',
        ...
        var graph_real = Morris.Line({
            ...
            pointStrokeColors: ['#A389D4', '#e11b22', '#7b1b67'],
            lineWidth: 2,
            hideHover: true
        });
