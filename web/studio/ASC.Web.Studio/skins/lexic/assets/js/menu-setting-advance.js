                ...
                '<div class="tab-content" id="pills-cust-tabContent">' +
                    '<div class="tab-pane fade show active" id="pills-color" role="tabpanel" aria-labelledby="pills-color-tab">' +
                        ...
                        '<div class="theme-color laybg-color small">' +
                            '<a href="#!" class="" data-value="#7b1b67" style="background:#7b1b67"></a>' +
                            ...
                            '<a href="#!" class="" data-value="linear-gradient(to right, #e11b22 0%, #f01018 100%)" style="background:linear-gradient(to right, #e11b22 0%, #f01018 100%)"></a>' +
                            '<a href="#!" class="" data-value="linear-gradient(to right, #7B1B67 0%, #A389D4 100%)" style="background:linear-gradient(to right, #7B1B67 0%, #A389D4 100%)"></a>' +
