...
<div class="clearFix">
     <div id="studio_passwordSettings" class="settings-block">
        ...
        <div class="clearFix fieldsBox">
            ...
            <div class="clearFix">
                <input type="checkbox" id="chkLowerSymbols" />
                <label for="chkLowerSymbols">Use lower case character</label>
            </div>
            <div class="clearFix">
                <input type="checkbox" id="chkReUserSymbols" />
                <label for="chkReUserSymbols">Unable to reuse 6 or more previous passwords</label>
            </div>
            <div class="clearFix">
                <input type="checkbox" id="chkAttemptsSymbols" />
                <label for="chkAttemptsSymbols">3 failed login attempts</label>
            </div>
        </div>
