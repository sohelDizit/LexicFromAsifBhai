...
PasswordSettingsManager = new function () {
    ...
    this.LoadSettings = function () {
        PasswordSettingsController.LoadPasswordSettings(function (result) {
            ...
            jq("#chkLowerSymbols").prop("checked", jsonObj.ChkLowerSymbols);
            jq("#chkReUserSymbols").prop("checked", jsonObj.ChkReUserSymbols);
            jq("#chkAttemptsSymbols").prop("checked", jsonObj.ChkAttemptsSymbols);
            console.log(jsonObj);
            onSlide();
        });
    };
    ...
    this.SaveSettings = function () {
        ...
        var jsonObj = {
            ...
            "ChkLowerSymbols": jq("input#chkLowerSymbols").is(":checked"),
            "ChkReUserSymbols": jq("input#chkReUserSymbols").is(":checked"),
            "ChkAttemptsSymbols": jq("input#chkAttemptsSymbols").is(":checked"),
        };
