...
namespace ASC.Web.Core.Utility
{
    ...
    public sealed class PasswordSettings : BaseSettings<PasswordSettings>
    {
        ...
        [DataMember]
        public bool ChkLowerSymbols { get; set; }

        [DataMember]
        public bool ChkReUserSymbols { get; set; }

        [DataMember]
        public bool ChkAttemptsSymbols { get; set; }
        ...
        public static string GetPasswordRegex(PasswordSettings passwordSettings)
        {
            ...
            //{
                ...
                if (passwordSettings.ChkLowerSymbols)
                    pwdBuilder.Append(@"(?=.*[a-z])");
