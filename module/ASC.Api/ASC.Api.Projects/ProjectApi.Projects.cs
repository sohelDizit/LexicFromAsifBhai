...
namespace ASC.Api.Projects
{
    public partial class ProjectApi
    {
        ...
        public ProjectWrapperFull GetProject(int id)
        {
            ...
            var result = new ProjectWrapperFull(this, EngineFactory.ProjectEngine.GetFullProjectByID(id).NotFoundIfNull(), EngineFactory.FileEngine.GetRoot(id), isFollow, tags);
            return result;
        }
            ...
            string projectNumber)
        {
            var project = CreateProject(title, description, responsibleId, tags, @private,
                participants.Select(r => r.ID).ToList(), notify, tasks, milestones, notifyResponsibles, projectNumber);
        ...
        [Read("GetProjectNumber")]
        public Project GetProjectNumber(int id) 
        {
            return EngineFactory.ProjectEngine.GetProjectNumber(id);
        }
